...
{
            /* Contrary to the UWP XAML apps, WinUI 3 apps do not have a public static 
               ResourceManager or ResourceLoader object. When localizing a control with x:UI,  
               WinUI 3 creates a ResourceManager internally, 
               but you can't get the instance - you will need to create one. 
               You can use the Singleton pattern to accomplish it.*/
