...
namespace winrt::ContosoAirlinePOSCpp::implementation
{
    ...
    void BookFlightPage::FlyingFromAutoSuggestBox_SuggestionChosen(winrt::Microsoft::UI::Xaml::Controls::AutoSuggestBox const& , winrt::Microsoft::UI::Xaml::Controls::AutoSuggestBoxSuggestionChosenEventArgs const& args)
    {
    ...
    void BookFlightPage::FlyingToAutoSuggestBox_SuggestionChosen(winrt::Microsoft::UI::Xaml::Controls::AutoSuggestBox const& , winrt::Microsoft::UI::Xaml::Controls::AutoSuggestBoxSuggestionChosenEventArgs const& args)
    {
        Airport airport = unbox_value<Airport>(args.SelectedItem());
