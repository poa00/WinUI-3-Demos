...
namespace winrt::ContosoAirlinePOSCpp::implementation
{
    ...
    void FlightReservationPage::PaymentButton_Click(winrt::Windows::Foundation::IInspectable const& , winrt::Microsoft::UI::Xaml::RoutedEventArgs const& )
    {
    ...
    void FlightReservationPage::SeatSelectionButton_Click(winrt::Windows::Foundation::IInspectable const& , winrt::Microsoft::UI::Xaml::RoutedEventArgs const& )
    {
